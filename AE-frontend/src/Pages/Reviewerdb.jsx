...
const Reviewerdb = () => {
  ...
  return (
    <>
      <Navbar />
      <section
        id="hero"className="min-vh-100 d-flex align-items-start text-center fade-in">
        <div>
<Link to={`/reviews`} className="btn btn-light ms-2 slide-from-right">reviews</Link>
</div>
